...
namespace DependencyPropertyBasic
{
    ...
    DependencyProperty.Register("Operator", typeof(string), typeof(CalculateControl), new PropertyMetadata("+", OnValueChanged), new ValidateValueCallback(IsValiOperator));
    ...
    DependencyProperty.Register("DesignMode", typeof(DesignMode), typeof(CalculateControl), new PropertyMetadata(DesignMode.White, OnDesignModeChanged));
        ...
        private static bool IsValiOperator(object value)
        {
