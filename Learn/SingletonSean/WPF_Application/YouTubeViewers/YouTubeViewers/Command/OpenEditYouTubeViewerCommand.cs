...
namespace YouTubeViewers.Command
{
    public class OpenEditYouTubeViewerCommand : CommandBase
    {
        ...
        public OpenEditYouTubeViewerCommand(
            YouTubeViewersListingItemViewModel youTubeViewersListingItemViewModel, YouTubeViewersStore youTubeViewersStore, ModalNavigationStore modalNavigationStore)
        {
